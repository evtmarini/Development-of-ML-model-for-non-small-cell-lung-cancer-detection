...
from src.evaluation import run_experiments   # ✅ Halving Random Search
from src import explainability               # ✅ Explainability (SHAP + LIME)
...
# === 2️⃣ Load and align center info === #
...
try:
    ...
    print(f"⚠️ No 'center' column found or could not load centers: {e}")
    centers = None

# === 3️⃣ Split & Heterogeneity Check === #
print("\n🔀 Creating stratified & grouped folds (by center if available)...")
...
print("⚙️ VarianceThreshold filter...")
...
print("⚙️ Kruskal/Mann–Whitney filtering...")
...
# === 6️⃣ MODEL TRAINING (CROSS-VALIDATION) === #
...
# === 7️⃣ ADVANCED EVALUATION (HALVING RANDOM SEARCH) === #
